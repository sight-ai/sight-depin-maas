...
export const OllamaCompletionResponse = z.object({
  model: z.string(),
  created_at: z.string(),
  response: z.string(),
  done: z.boolean(),
...
// DeepSeek chat params
export const DeepSeekChatParams = z.object({
  model: z.string(),
  messages: z.array(ChatMessage),
  temperature: z.number().optional(),
  top_p: z.number().optional(),
...
// DeepSeek completion params
export const DeepSeekCompletionParams = z.object({
  model: z.string(),
  prompt: z.string(),
  suffix: z.string().optional(),
  max_tokens: z.number().optional(),
...
// DeepSeek embedding params
export const DeepSeekEmbeddingParams = z.object({
  model: z.string(),
  input: z.union([z.string(), z.array(z.string())]),
  encoding_format: z.enum(['float', 'base64']).optional(),
  user: z.string().optional(),
...
export const DeepSeekChatResponse = z.object({
  id: z.string(),
  object: z.string(),
  created: z.number(),
  model: z.string(),
...
export const DeepSeekCompletionResponse = z.object({
  id: z.string(),
  object: z.string(),
  created: z.number(),
  model: z.string(),
...
// DeepSeek embedding response
export const DeepSeekEmbeddingResponse = z.object({
  object: z.string(),
  data: z.array(z.object({
    object: z.string(),
    embedding: z.array(z.number()),
