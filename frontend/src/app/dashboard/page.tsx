...
export default function DashboardPage() {
    ...
    return (
        <MainContent>
            <main className="flex-1 p-8 space-y-8 h-full" style={{
                ...
                <UptimeCard statistics={summary} loading={loading} error={error} />
                <Card className=' rounded-lg'>
                    <div className="space-y-5 p-3 rounded-lg m-5" style={{
                        height: '25rem'
                    }}>
                        <div className="flex items-center justify-between">
                            <h2 className="text-2xl font-semibold text-black  text-primary" style={{
                                color: isDark ? '#fff' : '#000'
                            }}>Earning Statistics</h2>
                            <Button className="text-black" onClick={refreshStatistics}>
