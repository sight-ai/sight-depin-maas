...
export function DeviceCard() {
    ...
    return (
        <Card className="p-5 bg-white rounded-lg ml-6 flex-1" style={{
            backgroundColor: isDark ? '#1a1a1a' : '#f6f6f6'
        }}>
            <h2 className="text-2xl  mb-3 text-black underline flex" style={{
                fontSize: '2.075em',
                color: isDark ? '#fff' : '#000'
            }}>NEW-DEVICE   <Image src="/Vector 1.svg" alt="SIGHT Logo" width={20} height={20} className='ml-5' style={{ height: 'auto' }} /></h2>
            <div className="flex items-start gap-1 flex-col mt-3">
                <div className="flex items-center gap-3">
                    <div className="text-base font-semibold text-black " style={{
                        color: isDark ? '#fff' : '#000',
                    }}>Device</div>
                    <div className="text-base text-black bg-[red]" style={{
                        color: isDark ? '#fff' : '#000',
                    }}>Macbook Pro 16''</div>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <div className="text-base text-black" style={{
                        color: isDark ? '#fff' : '#000',
                    }}>Offline</div>
                </div>
