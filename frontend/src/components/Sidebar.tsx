...
export function Sidebar() {
    ...
    return (
        ...
        >
            <div className="flex items-center justify-center mb-15 mt-12">
                <Image src={isDark ? "/LOGO-H-white.png" : "/LOGO-H-black.png"} alt="SIGHT Logo" width={150} height={58} className="w-auto h-auto" />
            </div>
            <Navigation />
            <ThemeSwitch />
        </aside>
